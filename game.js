...
BasicGame.Game.prototype = {
  ...
  create: function () {
	...
	var prepEnemies = [
      { key: 'greenEnemy', count: 100 },
      { key: 'whiteEnemy', count: 100 },
      { key: 'boss', count: 5 }
    ]
  ...
  fire: function() {
    if (this.nextFire < this.time.now && this.bullets.countDead() > 0 && this.player.alive) {
  ...
  update: function () {
    ...
    if (this.nextEnemy < this.time.now && this.enemies.countDead() > 0) {
    ...
    checkWave: function () {
    if (this.wave === 1 && this.score >= 500) {
      this.wave = 2;
      this.spawnRate = [800, 2500];
    } else if (this.wave === 2 && this.score >= 1000) {
      this.wave = 3;
      this.spawnRate = [600, 2000];
    } else if (this.wave === 3 && this.score >= 1500) {
      this.wave = 4;
